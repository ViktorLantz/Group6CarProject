...
#include "../../../../../../../odcockpit/include/plugins/irusmap/IrUsMapWidgetControl.h"
...
void *cockpit::plugins::irusmap::IrUsMapWidgetControl::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "odcore::io::conference::ContainerListener"))
        return static_cast< odcore::io::conference::ContainerListener*>(const_cast< IrUsMapWidgetControl*>(this));
