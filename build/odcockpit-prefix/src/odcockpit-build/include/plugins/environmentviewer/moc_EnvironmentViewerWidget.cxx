...
#include "../../../../../../../odcockpit/include/plugins/environmentviewer/EnvironmentViewerWidget.h"
...
void *cockpit::plugins::environmentviewer::EnvironmentViewerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "odcore::io::conference::ContainerListener"))
        return static_cast< odcore::io::conference::ContainerListener*>(const_cast< EnvironmentViewerWidget*>(this));
