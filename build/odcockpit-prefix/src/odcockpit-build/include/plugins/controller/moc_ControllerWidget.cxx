...
#include "../../../../../../../odcockpit/include/plugins/controller/ControllerWidget.h"
...
void *cockpit::plugins::controller::ControllerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "odcore::io::conference::ContainerListener"))
        return static_cast< odcore::io::conference::ContainerListener*>(const_cast< ControllerWidget*>(this));
