...
#include "../../../../../../../odcockpit/include/plugins/sharedimageviewer/SharedImageViewerWidget.h"
...
void *cockpit::plugins::sharedimageviewer::SharedImageViewerWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "odcore::io::conference::ContainerListener"))
        return static_cast< odcore::io::conference::ContainerListener*>(const_cast< SharedImageViewerWidget*>(this));
