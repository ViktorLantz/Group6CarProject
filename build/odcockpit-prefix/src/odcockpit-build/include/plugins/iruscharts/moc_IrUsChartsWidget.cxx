...
#include "../../../../../../../odcockpit/include/plugins/iruscharts/IrUsChartsWidget.h"
...
void *cockpit::plugins::iruscharts::IrUsChartsWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "odcore::io::conference::ContainerListener"))
        return static_cast< odcore::io::conference::ContainerListener*>(const_cast< IrUsChartsWidget*>(this));
